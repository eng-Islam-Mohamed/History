        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr_0.9fr_280px]">
          ...
          <div className="lg:justify-self-end">
            ...
            <div className="mt-4 flex justify-center lg:justify-end">
              <div className="social-card" data-locale={locale}>
                ...
                >
                  <div className="social-card__box social-card__box--1">
                ...
                <a
                  ...
                  className="social-card__link"
                >
                  <div className="social-card__box social-card__box--2">
                    <span className="social-card__icon">
                      <svg
                        viewBox="0 0 320 512"
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <a
                  ...
                  className="social-card__link"
                >
                  <div className="social-card__box social-card__box--3">
                    <span className="social-card__icon">
                      <svg
                        viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div aria-hidden="true" className="social-card__box social-card__box--4" />
              </div>
            </div>
          </div>
        </div>
