          ...
          <div className="lg:justify-self-end">
            ...
            <div className="mt-4 flex justify-center lg:justify-end">
              <div className="social-card">
                ...
                <div className="social-card__logo">Socials</div>
                ...
                <a
                  ...
                  className="social-card__box social-card__box--instagram"
                >
                ...
                <a
                  ...
                  rel="noreferrer"
                  aria-label="GitHub"
                  className="social-card__box social-card__box--github"
                >
                  <span className="social-card__icon">
                    <svg
                      viewBox="0 0 24 24"
                ...
                <a
                  ...
                  rel="noreferrer"
                  aria-label="Facebook"
                  className="social-card__box social-card__box--facebook"
                >
                  <span className="social-card__icon">
                    <svg
                      viewBox="0 0 320 512"
                ...
                <div className="social-card__box social-card__box--echo" />
              </div>
            </div>
          </div>
        </div>
