...
interface SearchArchiveLoaderProps {
  label: string;
  detail?: string;
  variant?: 'panel' | 'inline';
}

export default function SearchArchiveLoader({
  label,
  detail,
  variant = 'panel',
}: SearchArchiveLoaderProps) {
  const loaderId = useId().replace(/:/g, '');
  const topClipId = `${loaderId}-sand-top`;
  const bottomClipId = `${loaderId}-sand-bottom`;
  const isInline = variant === 'inline';

  return (
    <div
      className={`search-loader-shell${isInline ? ' search-loader-shell--inline' : ''}`}
      role="status"
      aria-live="polite"
    >
      <svg
        ...
        role="img"
        viewBox="0 0 56 56"
        className={`search-loader${isInline ? ' search-loader--inline' : ''}`}
      >
        <clipPath id={topClipId}>
          <path
            ...
            className="search-loader__sand-mound-top"
          />
        </clipPath>
        <clipPath id={bottomClipId}>
          <path
            ...
            className="search-loader__sand-mound-bottom"
          />
        </clipPath>
        <g transform="translate(2,2)">
          ...
          >
            <circle
              ...
              cx="26"
              strokeWidth="2.5"
              className="search-loader__motion-thick"
            />
            <circle
              transform="rotate(90,26,26)"
              r="24.5"
              ...
              cx="26"
              strokeWidth="1.75"
              className="search-loader__motion-medium"
            />
            <circle
              ...
              cx="26"
              strokeWidth="1"
              className="search-loader__motion-thin"
            />
          </g>

          <g transform="translate(13.75,9.25)" className="search-loader__model">
            <path
              ...
              className="search-loader__glass"
            />

            <g strokeLinecap="round" className="search-loader__sand">
              <line
                y2="20.75"
                x2="12"
                y1="15.75"
                ...
                strokeWidth="1"
                className="search-loader__sand-grain-left"
              />
              <line
                y2="21.75"
                x2="12.5"
                ...
                strokeDasharray="0.25 33.75"
                strokeWidth="1"
                className="search-loader__sand-grain-right"
              />
              <line
                y2="31.5"
                x2="12.25"
                ...
                strokeWidth="1"
                className="search-loader__sand-drop"
              />
              <line
                y2="31.5"
                x2="12.25"
                ...
                strokeWidth="1.5"
                className="search-loader__sand-fill"
              />
              <line
                y2="31.5"
                x2="12"
                ...
                strokeWidth="1"
                className="search-loader__sand-line-left"
              />
              <line
                y2="31.5"
                x2="12.5"
                ...
                strokeWidth="1"
                className="search-loader__sand-line-right"
              />

              <g strokeWidth="0" className="search-loader__sand-pool">
                <path
            ...
            <g strokeWidth="2" strokeLinecap="round" opacity="0.72" fill="none">
              <path
                d="M 19.437 3.421 C 19.437 3.421 19.671 6.454 17.914 8.846 C 16.157 11.238 14.5 11.5 14.5 11.5"
                className="search-loader__glare-top"
              />
              <path
                transform="rotate(180,12.25,16.75)"
                d="M 19.437 3.421 C 19.437 3.421 19.671 6.454 17.914 8.846 C 16.157 11.238 14.5 11.5 14.5 11.5"
                className="search-loader__glare-bottom"
              />
            </g>

            <rect height="2" width="24.5" className="search-loader__frame" />
            <rect
              height="1"
              width="19.5"
              y="0.5"
              ...
              ry="0.5"
              rx="0.5"
              className="search-loader__frame-highlight"
            />
            <rect
              height="2"
              width="24.5"
              y="31.5"
              className="search-loader__frame"
            />
            <rect
              height="1"
              width="19.5"
      ...
      <div className="search-loader-shell__copy">
        <p className="search-loader-shell__label">{label}</p>
        {!isInline && detail ? (
          <p className="search-loader-shell__detail">{detail}</p>
        ) : null}
      </div>
    </div>
  );
